                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">New User</h6>
                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Stored item</h6>
                                <h6 class="font-extrabold mb-0">88</h6>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        <td class="col-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="font-bold ms-3 mb-0">Si
                                                    Cantik</p>
                                            </div>
                                        </td>
                                        <td class="col-auto">
                                            <p class=" mb-0">This design shoooo gewd!</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="col-3">
            ...
            <div class="card-body py-4 px-4">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-xl">
                        <img src="{{   asset('assets/compiled/jpg/2.jpg')}}" alt="Face 1">
                    </div>
                    <div class="ms-3 name">
                        <h5 class="font-bold">Pengawas</h5>
                        <h6 class="text-muted mb-0">pengawas@localhost</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-content pb-4">
                <!-- <div class="recent-message d-flex px-4 py-3">
                    ...
                    <div class="name ms-4">
                        <h5 class="mb-1">Operator</h5>
                        <h6 class="text-muted mb-0">operator@localhost</h6>
                    </div>
                </div> -->
                <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                    ...
                    <div class="name ms-4">
                        ...
                        <h6 class="text-muted mb-0">user@localhost</h6>
                    </div>
                </div>
                <!-- <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                    ...
                    <div class="name ms-4">
                        ...
                        <h6 class="text-muted mb-0">admin@localhost</h6>
                    </div>
                </div> -->
                <div class="px-4">
