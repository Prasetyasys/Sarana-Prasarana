    ...
    <div class="card">
        <div class="card-header position-relative">
            ...
            <div class="approval-actions">
                <form action="{{ route('pengadaan.finish') }}" method="POST">
                    @csrf

                    <input type="hidden" name="id" value="{{ $pengadaan->code }}">
                    <button class="btn-approval btn-approve">
                        Setujui
                    </button>
                </form>
                <form action="{{ route('pengadaan.reject')}}" method="POST">
                    @csrf
                    ...
                    <div class="comment-header">
                        ...
                        <div class="comment-body">
                            ...
                            <div class="comment-actions">
                                <button type="button" class="btn icon icon-left btn-primary me-2 text-nowrap" data-bs-toggle="modal" data-bs-target="#submissionProcess">
