            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="font-extrabold mb-0">{{ $getSummaryData['barang_keluar'] }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="font-extrabold mb-0">{{ $getSummaryData['total_barang'] }}</h3>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="font-semibold">{{ $pmt->pegawai->name }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="status-badge status-menunggu">{{ $pmt->status }}</span>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
