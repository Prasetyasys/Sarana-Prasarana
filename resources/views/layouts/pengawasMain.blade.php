...
<body>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active ">
                            <a href="{{ route('pengawas') }}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu">
                                ...
                                {{-- <li class="submenu-item">
                                    <a href="" class="submenu-link">Laporan</a>
                                </li> --}}
                            </ul>
                        </li>
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item">
                                    <a href="{{ route('admin.pengadaan') }}" class="submenu-link">Pengajuan</a>
                                </li>
                                <li class="submenu-item">
                            ...
                            <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="user-menu d-flex">
                                    <div class="user-name text-end me-3">
                                        ...
                                        <p class="mb-0 text-sm text-gray-600 mt-2">{{ Auth::user()->role }}</p>
                                    </div>
    ...
    <script>
        new DataTable('#itemTablePengawas');
        new DataTable('#PengadaanTable');
        new DataTable('#PermintaanTable');
