...
<body>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('pict/logo.svg') }}" alt="Logo" width="110"
                                    height="50" style="height: 50px !important" /></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item">
                                    <a href="{{ route('admin.user') }}" class="submenu-link">User</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="{{ route('admin.pegawai') }}" class="submenu-link">Pegawai</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                ...
                                <li><a class="dropdown-item" href=""><i class="bi bi-envelope-arrow-down"></i>
                                        Chat </a></li>
                                <li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        new DataTable('#barangMasukTable');
        new DataTable('#barangKeluarTable');
    </script>
</body>
