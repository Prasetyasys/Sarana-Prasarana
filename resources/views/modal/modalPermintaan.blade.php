...
<div class="modal fade bd-permintaan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                <form action="{{ route('permintaan.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        <label for="supplier" class="mb-2">Unit</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="col-md-8 form-group form-control mb-4" id="regrading" name="regarding" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="supplier" class="mb-2">Sifat</label>
                        <select class="col-md-8 form-group form-select form-control mb-4" id="sifat" name="sifat">
                            <option selected hidden></option>
...
<script>
    ...
    function submitForm() {
        const form = document.querySelector('#permintaanForm');
        form.submit();
    }
</script>
