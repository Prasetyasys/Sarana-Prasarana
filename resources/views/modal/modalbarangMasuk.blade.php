...
<div class="modal fade bd-barangmasuk" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                <form action="{{ route('barangMasuk.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <select class="col-md-8 form-group form-select form-control mb-4" id="supplier"
                            name="supplier_code">
                        ...
                        <div class="form-group barang-form">
                            <div class="row mb-3">
                                <div class="col-md-7">
                                    ...
                                    <select class="form-select mb-4" name="namaBarang[]" required>
                                        <option selected hidden></option>
                                        @foreach ($item as $nb)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tambahFormBtn.addEventListener('click', function() {
            ...
            newForm.querySelector('select[name="namaBarang[]"]').value = '';
    ...
    function submitForm() {
        const form = document.querySelector('#barangMasukForm');
        form.submit();
    }
</script>
